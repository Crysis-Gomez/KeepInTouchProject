package screen 
{
	 ...
	 * @author Jerry
	 */
	public class SpeedScreen extends GameScreen 
	{
		...
		public function SpeedScreen() 
		{
			...
			var playerText1:TextField = Util.createTextfield("Select the speed", 1920, 100, 72, 0xFFFFFF);
			playerText1.x = 0;
			...
			var playerText2:TextField = Util.createTextfield("Select the speed",  1920, 100, 72, 0xFFFFFF);
			playerText2.x = 1920;
			...
			var button4Player1:Sprite = Util.createButton("1x", 120, 100, 0xFF8000);
			var button4Player2:Sprite = Util.createButton("1x", 120, 100, 0xFF8000);
			
			var button6Player1:Sprite = Util.createButton("2x", 120, 100, 0x400080);
			var button6Player2:Sprite = Util.createButton("2x", 120, 100, 0x400080);
		...
		{
			this.close();
			game.addScreen(new ScoreScreen());
		}
