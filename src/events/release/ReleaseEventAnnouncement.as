package events.release 
{
	 ...
	 * @author ...
	 */
	public class ReleaseEventAnnouncement extends GameEventAnnouncement
	{
		private var icon1:PlayerIcon;
		private var tokenHeight:Number = 0;
		private var distanceTravelled:Number = 0;
		
		public function ReleaseEventAnnouncement(eventType:int, playScreen:GameWorld, play:Function) 
		{
